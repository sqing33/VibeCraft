# repo-library-detail-workspace Specification
...
The card detail content area MUST scroll vertically as a whole when its content exceeds the available height.
