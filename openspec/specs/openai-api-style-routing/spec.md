# openai-api-style-routing Specification

## Purpose

Allow OpenAI-compatible gateways to be used automatically even when they support different text-generation endpoints (`responses` vs `chat/completions`).
