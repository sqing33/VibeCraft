# mcp-skill-settings Specification Delta
...
#### Scenario: Read Skill settings with enabled state
...
- **AND** skills without an explicit persisted binding default to enabled
