...
func Register(v1 *gin.RouterGroup, deps Deps) {
	...
	v1.GET("/settings/api-sources", getAPISourceSettingsHandler())
	v1.PUT("/settings/api-sources", putAPISourceSettingsHandler(deps))
	v1.GET("/settings/runtime-models", getRuntimeModelSettingsHandler())
	v1.PUT("/settings/runtime-models", putRuntimeModelSettingsHandler(deps))
